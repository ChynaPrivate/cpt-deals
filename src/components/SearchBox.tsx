    ...
    <div className="mt-2">
      ...
      <div className="relative">
        ...
        <input
          ...
          className="glass-btn text-ink placeholder:text-ink/70 w-full rounded-2xl py-3 pr-12 pl-12 text-[16px] font-semibold transition-colors outline-none placeholder:font-normal [&::-webkit-search-cancel-button]:hidden"
        />
